/**
 * @file cubic_spline.h
 * @author Cubic spline path generator
 * @brief Lightweight cubic spline interpolation utilities.
 * @version 0.1
 * @date 2021-09-20
 *
 ...
 * The coefficients are solved from value continuity, first- and
 * second-derivative continuity, and natural boundary conditions.
 */
class Spline {
 public:
  Vec_f x;
